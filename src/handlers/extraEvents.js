...
module.exports = {
  async execute(client) {
    let aio = `Welcome to ${'Server Handler'.bold.blue} by ${'𝓙𝓸𝓵𝓽𝔃'.red}`;
    let aio_server = `Support:- ${`https://dsc.gg/mystic-titans`.brightGreen}`
    let Uo = `Coded By ${`𝓙𝓸𝓵𝓽𝔃`.brightCyan.bold}`;
    console.clear()
